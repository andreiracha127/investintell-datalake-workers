...
def _validate_checkpoint_value(value: object, *, evidence: Phase4V2Evidence, approval: Phase4V2EvidenceApproval, mode: str, series: tuple[str, ...], run_id: str | None, budget: CalibrationBudget) -> dict[str, object]:
    """Validate a parsed checkpoint with the single authoritative invariant set."""
