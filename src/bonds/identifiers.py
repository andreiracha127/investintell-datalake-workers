"""Lossless CUSIP9 qualification for the observed bond panel.

Ported verbatim from the bond pilot: normalize only outer whitespace and casing,
never repair an identifier, and reject placeholders and synthetic prefixes so a
fabricated key can never enter the universe. Carries state + transformation.
"""
...
from .states import IdentifierState


_PLACEHOLDERS = frozenset(
    {"000000000", "XXXXXXXXX", "NNNNNNNNN", "999999999", "N/A", "NA", "NONE", "NULL", "UNKNOWN"}
)
