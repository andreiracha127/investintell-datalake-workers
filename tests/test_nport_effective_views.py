    ...
    with psycopg.connect(DSN, autocommit=True) as conn:
        with conn.cursor() as cur:
            ...
            for holding, cusip, lei, value, pct in (
                ("H1", "037 833 100", "5493001KJ TII GC8Y1R12", "123.45", "12.5"),
                ("H2", "037833100", "N O N E", "-20", "-2"),
                ("H3", " N / A ", "", "0", "0"),
            ):
            ...
            _insert_raw(cur, amendment, "IDENTIFIERS.tsv", {"HOLDING_ID": "H1", "IDENTIFIER_ISIN": "us03 7833 1005"}, holding="H1")
            ...
            _insert_raw(cur, amendment, "IDENTIFIERS.tsv", {"HOLDING_ID": "H3", "IDENTIFIER_ISIN": " N / A "}, holding="H3")
            ...
            cur.execute("SELECT selection_state FROM nport_effective_filing_selection WHERE accession_number='O1'")
            assert cur.fetchone() == ("superseded",)
            ...
            cur.execute("""SELECT holding_id,cusip,issuer_lei,isin_count,isin_conflict,cusip_placeholder,
                                  lei_placeholder,isin_placeholder,incomplete_identifier_candidate_key_evidence
                           FROM nport_identifier_surface ORDER BY holding_id""")
            assert cur.fetchall() == [
                ("H1", "037833100", "5493001KJTIIGC8Y1R12", 2, True, False, False, False, False),
                ("H2", "037833100", None, 0, False, False, True, False, True),
                ("H3", None, None, 1, False, True, False, True, False),
            ]
