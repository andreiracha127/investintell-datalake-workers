...
from src.bond_pilot.debt_mapping import load_approved_debt_mapping, load_fixture_debt_mapping
...
def test_metrics_keep_series_and_currencies_separate(mapping: object, tmp_path: Path) -> None:
    ...
    assert first.eligible_market_value_by_currency == {"USD": 10.0, "EUR": 20.0, "UNKNOWN": 7.0}
    assert first.matched_market_value_by_currency == {"USD": 10.0, "UNKNOWN": 7.0}
